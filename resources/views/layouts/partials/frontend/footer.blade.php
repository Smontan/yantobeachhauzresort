...
<div class="container">
    <footer class="d-flex flex-wrap justify-content-center justify-content-md-between align-items-center py-3 my-4 border-top">
      <p class="col-md-5 mb-0 text-body-secondary">&copy; Copyright 2023 . All rights reserved</p>
  
      
  
      <ul class="nav col-md-4 justify-content-end">
        <li class="nav-item"><a href="{{url('/')}}" class="nav-link px-2 text-body-secondary">Home</a></li>
        <li class="nav-item"><a href="{{url('/rooms')}}" class="nav-link px-2 text-body-secondary">Rooms</a></li>
